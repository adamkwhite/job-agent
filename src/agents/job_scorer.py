...
class JobScorer:
    ...
    def __init__(self):
        ...
        self.profile = {
            ...
            'domain_keywords': [
                'robotics', 'automation', 'iot', 'hardware', 'medtech', 'medical device',
                'mechatronics', 'embedded', 'firmware', 'mechanical', 'physical product',
                'manufacturing', 'supply chain', 'dfm', 'dfa', 'industrial'
            ],
            'role_types': {
            ...
            'location_preferences': {
                ...
                'preferred_cities': ['toronto', 'waterloo', 'burlington', 'oakville', 'hamilton',
                                    'mississauga', 'kitchener', 'guelph'],
    ...
    def _score_seniority(self, title: str) -> int:
        ...
        if any(keyword in title for keyword in ['vp ', 'vice president', 'chief', 'cto', 'cpo', 'head of']):
            return 30
    ...
    def _score_domain(self, title: str, company: str) -> int:
        ...
        hardware_keywords = ['robotics', 'automation', 'hardware', 'iot', 'mechatronics', 'embedded']
    ...
    def _score_role_type(self, title: str) -> int:
        ...
        if 'engineering' in title and any(kw in title for kw in ['vp', 'director', 'head', 'chief', 'executive']):
            return 20
    ...
    def _score_technical_keywords(self, title: str, company: str) -> int:
        ...
        tech_keywords = [
            'robotics', 'automation', 'iot', 'hardware', 'embedded',
            'firmware', 'mechanical', 'mechatronics', 'manufacturing',
            'supply chain', 'dfm', 'industrial', 'ml', 'ai'
        ]
